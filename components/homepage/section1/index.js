    ...
    return (
        <div className={style('card') + 'mt-[24px]'}>
            <div className={'flex flex-col text-center'}>
                ...
                <div className={'md:text-[18px] text-[16px] pt-[12px]' + style('text-des')}>
                    {data.des}
                </div>
            </div>
        </div>
        ...
        <div className={'w-full flex justify-center' + style('bg section1')}>
            <div className='w-full lg:max-w-[1440px] lg:w-[1440px] lg:px-[100px] lg:pt-[120px] lg:pb-[174px] px-[20px] py-[24px]'>
                <div className={style('mobi-pt-100')}>
                    <span className={style('cl-linear2 title-size')}>
                        HIỆN ĐẠI - HIỆU QUẢ - TIẾT KIỆM
                    </span>
                </div>
                <div className={'pt-[32px]'}>
                    <div className={'font-semibold text-[48px] leading-[110%]' + style('sub-title')}>
