...
export default function Section0() {
    ...
    return (
        <>
        <div className='w-[100%]'>
            <div className={'lg:pl-[100px] flex flex-col justify-between lg:flex-row lg:pt-[140px]' + style('bg section2')}>
                <div className="lg:flex lg:flex-col px-[20px]">
                    <div className={'pt-[100px] lg:pt-[50px] text-[#061D27]' + style('title')}>
                        <div>Giải pháp</div>
                        <div className="flex">
                            <div className="mr-[5px] relative w-[170px] lg:w-[365px]">
                                <span className="absolute z-10">One-stop</span>
                                <div className={style('image-onestop') + 'lg:hidden'}>
                                    <Image src={OneStopImage} width="193px" height="45px" />
                                </div>
                                <div className={style('image-onestop-to') + 'lg:block hidden'}>
                    ...
                    <div className="mt-[24px] font-style-16 lg:w-[391px] opacity-60">
                        Thay vì chỉ chia thưởng cho người giới thiệu trực tiếp như Affiliate truyền thống. Chúng tôi muốn chia quyền lợi cho cả khách mua hàng và những người giới thiệu trước đó. <a className={style('outside-link')} href="/Gioi-thieu-ViRef.pdf" target="_blank" rel="noopener noreferrer">Đọc thêm</a>
                    </div>
                    <div className={'mt-[24px] font-style-18 font-bold lg:mt-[110px]' + style('join-now')}>
                        <span className="lg:hidden" onClick={handleDownload}>Tham gia ngay</span>
                        <span className="lg:block hidden cursor-pointer" onClick={handleDownload}>Tham gia ngay</span>
                    </div>
                </div>
